"! @testing BDEF:ZRAP100_I_Travel_PIN
...
CLASS zrap100_tc_travel_eml_pin IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TRAVELTP_PIN' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zrap100_r_traveltp_pin
     ENTITY Travel
    ...
    SELECT * FROM zrap100_r_traveltp_001 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
